...
int main()
{
    ...
    try
    {
        ...
        // CREATE THE WINDOW.
        constexpr int SCREEN_WIDTH_IN_PIXELS = 900;
        constexpr int SCREEN_HEIGHT_IN_PIXELS = 700;
        constexpr SDL_WindowFlags WINDOW_SETTINGS = static_cast<SDL_WindowFlags>(SDL_WINDOW_SHOWN | SDL_WINDOW_RESIZABLE);
        ...
        bool window_info_obtained = SDL_GetWindowWMInfo(window, &window_info);
        std::printf("SDL window info obtained? %d\n", window_info_obtained);

        bgfx::Init bgfx_initialization_parameters;
        bgfx_initialization_parameters.platformData.nwh = window_info.info.win.window;
